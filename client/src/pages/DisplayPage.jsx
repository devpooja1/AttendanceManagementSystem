...
const DisplayPage = () => {
  ...
  // load students data with attendance status
  const StudentDisplay = async () => {
    ...
    try {
      ...
      alert('Failed to display students.');
    } finally {
      setLoading(false);
    }
  };
            ...
            <div className="card-body">
              ...
              {attendanceRecords.length > 0 ? (
                ...
                <div className="empty-state small">
                  <p>No attendance data records found for this date.</p>
                </div>
              ) : null}
            </div>
          </div>
